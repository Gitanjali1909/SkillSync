...
import intermediateQuestions from "../../data/intermediateQuestions"; // Your intermediate questions
...
const IntermediateQuizPage = () => {
  ...
  useEffect(() => {
    setQuestions(intermediateQuestions); // Load intermediate questions
  }, [setQuestions]);
